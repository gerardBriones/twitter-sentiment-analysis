# TDM_TA_emot_stem_tfidf.py
# Authors: Gerard Briones, Kasun Amarasinghe
# Creates the feature vector with unigrams plus incorporating word stemming and emoticon retention
...
# Arff for training
arff_file = 'TA_emot_stem_tfidf.arff'
...
writeFVtoARFF(arff_file_path+arff_file, selected_unigrams, tdm_tfIdf, tweet_ids, sentiment_classes, 'Sentiment_Analysis_Baseline_TaskA')