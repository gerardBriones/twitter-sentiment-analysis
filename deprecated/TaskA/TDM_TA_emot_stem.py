...
import csv
import dataCleaner_withStem # includes the stemming as well
...
writeFVtoARFF(arff_file_path+arff_file, selected_unigrams, tdm, tweet_ids, sentiment_classes, 'Sentiment_Analysis_TaskA_emot_stem')