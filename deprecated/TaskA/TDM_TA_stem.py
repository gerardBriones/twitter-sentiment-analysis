...
# Creates the feature vector with unigrams plus incorporating word stemming
# Combines the words with the same base form
...
# dict to hold the sentiment classes that exist and number of elements in each class (training and testing)
...
writeFVtoARFF(arff_file_path+arff_file, selected_unigrams, tdm, tweet_ids, sentiment_classes, 'Sentiment_Analysis_Unigram_Stem')