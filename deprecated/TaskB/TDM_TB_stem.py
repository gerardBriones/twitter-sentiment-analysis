...
# Creates the feature vector with unigrams for Task B, stemming is used in this version
...
writeFVtoARFF(arff_file_path+arff_file, selected_unigrams, tdm, tweet_ids, tweet_topic, sentiment_classes, 'Sentiment_Analysis_TaskB_stem')